...
public class DefaultJeepSalesDao implements JeepSalesDao {
  ...
  @Autowired
  // Spring managed connection tool
...
//     Week 15: for second and third example comment out the return null.
    // @formatter:off
    String sql = ""
        + "SELECT * "
        + "FROM models "
    ...
    // using a Map to inject the model and trim into our sql query.
    Map<String, Object> params = new HashMap<>();
    params.put("model_id", model.toString());
    params.put("trim_level", trim);
    return jdbcTemplate.query(sql, params, new RowMapper<>() {
      
      // RowMapper body called by jdbcTemplate query.
      @Override
